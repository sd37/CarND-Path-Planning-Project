...
LANE_TYPE
BehaviorPlanner::reco_lane(double ref_vel, LANE_TYPE lane, vector<OtherCar> left_lane, vector<OtherCar> middle_lane,
                           vector<OtherCar> right_lane, double car_s) {
    LANE_TYPE reco_lane;
    reco_lane = lane;

    //for (int i = 0; i < middle_lane.size(); ++i) {
    //     cout << middle_lane[i].s;
    //}
